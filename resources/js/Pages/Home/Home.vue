<template>
    <div class="flex flex-col h-screen">
        <nav
            class="flex items-center justify-between flex-wrap bg-gray-900 dark:bg-gray-900 p-6"
        >
            <div class="flex items-center flex-shrink-0 text-white mr-6">
                ...
                <router-link to="/" class="font-normal text-xl tracking-tight"
                    >SPARTA / SPARTU</router-link
                >
            </div>
        ...
        <div class="flex-grow bg-gray-900 dark:bg-gray-900">
            <RouterView />
        </div>
    </div>
</template>
